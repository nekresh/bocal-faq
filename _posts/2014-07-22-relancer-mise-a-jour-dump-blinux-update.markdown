...
En utilisant le fonctionnement simple du dump [blinux]({{ site.baseurl }}{% post_url 2014-07-18-fonctionnement-dump-blinux %}), le script suivant, exécuté en root, permet de forcer l'installation/désinstallation pour la release en cours :
